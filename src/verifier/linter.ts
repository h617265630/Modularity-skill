...
export class Linter {
  ...
  constructor(language: 'python' | 'typescript' = 'python') {
   ...
   * 运行 Lint 检查
   */
  async runLint(code: string): Promise<LintResult> {
    try {
   ...
   * 运行 Python Lint
   */
  private async runPythonLint(code: string): Promise<LintResult> {
   ...
   * 运行 TypeScript Lint
   */
  private async runTypeScriptLint(code: string): Promise<LintResult> {
...
export class TypeChecker {
   ...
   * 运行类型检查
   */
  async run(code: string): Promise<TypeCheckResult> {
    try {
      await this.ensureTempDir();
   ...
   * 运行 Python 类型检查
   */
  private async runPythonTypeCheck(code: string): Promise<TypeCheckResult> {
   ...
   * 运行 TypeScript 类型检查
   */
  private async runTypeScriptTypeCheck(code: string): Promise<TypeCheckResult> {
