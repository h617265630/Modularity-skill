 ...
 * 验证阶段
 */
export type VerificationStage = 'init' | 'generating_tests' | 'running_tests' | 'fixing_tests' | 'running_lint' | 'running_type_check' | 'checking_contracts' | 'checking_integration' | 'complete' | 'failed';
/**
 * 契约测试结果
 */
