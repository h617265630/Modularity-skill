 ...
 * 准备 UI 生成的上下文
 */
export function prepareUIContext(template) {
    return {
 ...
 * 生成 UI 增强提示词
 */
export function generateUIPrompt(context) {
 ...
 */
export async function generateModuleUI(context) {
 ...
 * 生成默认 UI（骨架代码）
 */
function generateDefaultUI(context) {
    const pages = {};
    // 为主页面生成骨架
 ...
 * 生成默认页面组件
 */
function generateDefaultPage(context) {
